...
var RBAC = (function() {
    ...
    var get_path = function(resource) {
        ...
        // if((resource.indexOf("v2") !== -1) && (resource.indexOf("v2/entities") === -1)){
